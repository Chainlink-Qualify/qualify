    ...
    return (
        <>
            ...
            >
                <Grid>
                    <Grid.Col span={6}>
                        <TextInput label={"First name"} value={name.split(" ")[0]} />
                    </Grid.Col>

                    <Grid.Col span={6}>
                        <TextInput label={"Last name"} value={name.split(" ")[1]} />
                    </Grid.Col>

                    <Grid.Col span={12}>
                        <TextInput label={"Email"} value={email} type="email" />
                    </Grid.Col>
                    ...
                    <Grid.Col span={6}>
                        <DateInput label={"Date of registration"} />
                    </Grid.Col>
                </Grid>
            </Modal>
